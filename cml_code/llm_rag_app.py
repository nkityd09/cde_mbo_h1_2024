...
def main():
    ...
    demo = gradio.Interface(fn=get_responses, 
                            ...
                            examples=["How much has Netflix stock climbed ?",
                                      "What is the most common investment held by Gen Z ?",
                                      "Is Crypto a risky bet ?"],
...
def load_context_chunk_from_data(id_path):
    try:
        ...
        file_obj = s3_client.get_object(Bucket=s3_bucket, Key=id_path)
